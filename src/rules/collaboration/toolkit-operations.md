...
> How to create, update, and deploy agents, rules, skills, and profiles in the toolkit.
...
|---|---|---|
| `collaboration` | `src/rules/collaboration/` | Git, design patterns, operational constraints, toolkit ops, knowledge management |
